...
import egovframework.diam.biz.db.member.MemberLoginLogMapper;
...
public class MemberLoginLogServiceImpl extends EgovAbstractServiceImpl implements MemberLoginLogService {
	
	@Resource(name="memberLoginLogMapper")
	...
	*/
	@Override
	public List<Dm_login_log_vo> selectLoginLogList(Dm_login_log_vo vo) throws Exception {
		List<Dm_login_log_vo> result = memberLoginLogMapper.selectLoginLogList(vo);
		return result;
	}
	...
	*/
	@Override
	public int selectLoginLogListCnt(Dm_login_log_vo vo) throws Exception {
		int result = memberLoginLogMapper.selectLoginLogListCnt(vo);
		return result;
	}
