...
public interface StatisticsMemberService {
	...
	public Dm_statistics_member_vo selectMemberStatisticsMaxMonthNewMember(Dm_statistics_member_vo vo) throws Exception;
	public Dm_statistics_member_vo selectMemberStatisticsMinMonthNewMember(Dm_statistics_member_vo vo) throws Exception;
	...
	public List<Dm_statistics_member_vo> selectMemberStatisticsAllDayMemberChart(Dm_statistics_member_vo vo) throws Exception;
	public Dm_statistics_member_vo selectMemberStatisticsAllMonthMemberChart(Dm_statistics_member_vo vo) throws Exception;
	...
	public List<Dm_statistics_member_vo> selectMemberStatisticsNewMemberMonthChart(Dm_statistics_member_vo vo) throws Exception;
	public Dm_statistics_member_vo selectMemberStatisticsAllMonthMember(Dm_statistics_member_vo vo) throws Exception;
	public List<Dm_statistics_member_vo> selectMemberStatisticsAllMemberMonthChart(Dm_statistics_member_vo vo) throws Exception;
	public List<Dm_statistics_member_vo> selectMemberStatisticsWeeklyMember(Dm_statistics_member_vo vo) throws Exception;
