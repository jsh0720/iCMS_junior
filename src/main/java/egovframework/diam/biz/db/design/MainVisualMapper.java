...
/**
 * @Class Name : MainVisualMapper.java
 * @Description : 사용자페이지 메인페이지에 표출되는 메인비주얼 데이터 CRUD 메소드를 수행하는 Mapper Interface
 * @author 디자인아이엠 개발팀 한연재
 * @since 2021.11.16
 * @version 1.0
*/

@Mapper("mainVisualMapper")
public interface MainVisualMapper {
	...
	*/
	public List<Dm_main_visual_vo> selectMainVisualList(Dm_main_visual_vo vo);
	...
	*/
	public int insertMainVisual(Dm_main_visual_vo vo);
	...
	*/
	public int updateMainVisual(Dm_main_visual_vo vo);
	...
	*/
	public int deleteMainVisual(Dm_main_visual_vo vo);
	...
	*/
	public int selectMainVisualListCnt(Dm_main_visual_vo vo);
	...
	*/
	public Dm_main_visual_vo selectMainVisualByDmid(Dm_main_visual_vo vo);
	 ...
	 * @return List<Dm_main_visual_vo> 조회된 메인비주얼 데이터를 List 자료형으로 전달
	*/
	public List<Dm_main_visual_vo> selectMainVisualListForWeb(Dm_main_visual_vo vo);
}
