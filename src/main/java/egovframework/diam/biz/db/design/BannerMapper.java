...
/**
 * @Class Name : BannerMapper.java
 * @Description : 사용자페이지 메인페이지에 표출되는 배너 데이터 CRUD 메소드를 수행하는 Mapper Interface
...
public interface BannerMapper {
	...
	*/
	public int selectBannerListCnt(Dm_banners_vo vo);
	...
	*/
	public List<Dm_banners_vo> selectBannerList(Dm_banners_vo vo);
	...
	*/
	public Dm_banners_vo selectBanner(Dm_banners_vo vo);
	...
	*/
	public int deleteBanner(Dm_banners_vo vo);
	...
	*/
	public int insertBanner(Dm_banners_vo vo);
	...
	*/
	public int updateBanner(Dm_banners_vo vo);
	...
	*/
	public List<Dm_banners_vo> selectBannerListForWeb(Dm_banners_vo vo);	
}
