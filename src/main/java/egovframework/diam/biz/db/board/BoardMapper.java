 ...
 * @Description : 게시판관리 게시판 데이터 CRUD 메소드를 수행하는 Mapper Interface
...
public interface BoardMapper {
	...
	*/
	public List<Dm_board_vo> selectBoardList(Dm_board_vo vo);
	...
	*/
	public Dm_board_vo selectBoard(Dm_board_vo vo);
	...
	*/
	public int insertBoard(Dm_board_vo vo);
	...
	*/
	public int updateBoard(Dm_board_vo vo);
	...
	*/
	public int deleteBoard(Dm_board_vo vo);
	...
	*/
	public int selectBoardListCnt(Dm_board_vo vo);
	...
	*/
	public List<Dm_board_vo> selectBoardListForWrite(Dm_board_vo vo);
	 ...
	 * @return Dm_board_vo 조회된 게시판데이터를 게시판데이터 vo객체에 담아 전달
	*/	
	public Dm_board_vo selectBoardbyDmTable(Dm_board_vo vo);
	
	public List<Dm_board_vo> selectMainBoardList(Dm_board_vo vo);
}
