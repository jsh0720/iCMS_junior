 ...
 * @Description : 사용자페이지 메인/서브 상단에 사용되는 메뉴 데이터 CRUD 메소드를 수행하는 Mapper Interface
...
public interface MenuMapper {
	...
	*/
	public List<Dm_menus_vo> selectMenuList(Dm_menus_vo vo);
	 ...
	 * @return List<Dm_menus_vo> 조회된 사용자메뉴 데이터를 List 자료형으로 전달
	*/
	public List<Dm_menus_vo> selectMenuRootChild(Dm_menus_vo vo);
	...
	*/
	public Dm_menus_vo selectMenuByParentId(Dm_menus_vo vo);
	...
	*/
	public int insertMenu(Dm_menus_vo vo);
	...
	*/
	public int updateMenu(Dm_menus_vo vo);
	 ...
	 * @return List<Dm_menus_vo> 조회된 사용자메뉴 데이터를 List 자료형으로 전달
	*/
	public List<Dm_menus_vo> selectMenuListByParentId(Dm_menus_vo vo);
	...
	*/
	public int deleteMenuByDmid(Dm_menus_vo vo);
	 ...
	 * @return List<Dm_menus_vo> 조회된 사용자메뉴 데이터를 List 자료형으로 전달
	*/
	public List<Dm_menus_vo> selectMenuListDesc(Dm_menus_vo vo);
	...
	*/
	public int insertMenuRoot(Dm_menus_vo vo);
	 ...
	 * @return Dm_menus_vo 조회된 사용자메뉴 데이터를 사용자메뉴 데이터 vo객체에 담아 전달
	*/
	public Dm_menus_vo selectMenuByDmId(Dm_menus_vo vo);
