 ...
 * @Description : CMS 기능별 공통으로 사용하는 조회 메소드를 수행하는 Mapper Interface
...
public interface CommonMapper {
	...
	*/
	public List<Dm_common_code_vo> selectDm_common_code(Dm_common_code_vo vo);
	...
	*/
	public List<Dm_board_vo> selectBoardListAll(Dm_board_vo vo);
