...
/**
 * @Class Name : LoginLockMapper.java
 * @Description : 관리자 페이지 로그인 실패 시 잠금 프로세스 메소드를 수행하는 Mapper Interface
 * @author 디자인아이엠 개발팀 한연재
 * @since 2021.11.16
 * @version 1.0
*/

@Mapper("loginLockMapper")
public interface LoginLockMapper {
	...
	*/
	public int selectLoginLockListCnt(Dm_member_vo vo);
	...
	*/
	public List<Dm_member_vo> selectLoginLockList(Dm_member_vo vo);
	...
	*/
	public Dm_member_vo selectLockMember(Dm_member_vo vo);
	...
	*/
	public int unlockMember(Dm_member_vo vo);
}
