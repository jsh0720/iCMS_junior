...
/**
 * @Class Name : LoginAuthMapper.java
 * @Description : 관리자/사용자 페이지 로그인 프로세스 메소드를 수행하는 Mapper Interface
 * @author 디자인아이엠 개발팀 한연재
 * @since 2021.11.16
 * @version 1.0
*/

@Mapper("loginAuthMapper")
public interface LoginAuthMapper {
	...
	*/
	int selectLoginFailCnt(LoginVO vo) throws Exception;
	...
	*/
	void updateMemberUnlock(LoginVO vo) throws Exception;
	...
	*/
	void updateLoginFailCnt(LoginVO vo) throws Exception;
	...
	*/
	void updateLoginFailCntLock(LoginVO vo) throws Exception;
	...
	*/
	void updateMemberPasswordChange(LoginVO vo) throws Exception;
}
