...
.reply_title {font-size:17px; text-align:center;} 
.reply_table {width:100%; border-top:2px solid #333; border-bottom:1px solid #999; margin-bottom:15px;}
.reply_table tr {border-bottom:1px solid #ddd;}
.reply_table tr th {padding:15px 0; text-align:center; color:#111; font-size:15px; font-weight:700; word-break:keep-all; background:#fff;}
.reply_table tr td {padding:15px 20px; line-height:1.5; word-break:keep-all;}
.reply_table tr td textarea {width:100%;}

.reply_btn {display:table; margin:0 auto;}
.reply_btn a {display:inline-block; font-size:14px; font-weight:300; color:#fff; border:1px solid #c6c6c6; padding:7px 15px; text-decoration:none; margin:0 3px;}
.reply_btn a.confirm {background:#4b449c;}
.reply_btn a.cancel {background:#23272b;}
		...
		<tbody>
			...
			<c:choose>
				<c:when test="${DiamLoginVO.id eq null }">
					<tr>
						<th><label for="wr_password">비밀번호<span class="required_value">*</span></label></th>
						<td><input type="password" name="wr_password" id="wr_password" autocomplete="new-password"/></td>
					</tr>
					<tr>
			...
			<tr>
				<th><label for="wr_content">내용<span class="required_value">*</span></label></th>
				<td><textarea name="wr_content" id="wr_content" rows="5" placeholder="댓글 내용을 입력해주세요."></textarea></td>
			</tr>
		</tbody>  
	</table>
	<div class="reply_btn">
		<a href="javascript:replyComment()" class="confirm">전송</a>
