...
function fnNew() {
	window.open("/adm/main_visual_form.do","mainvisual_new",option);    
}
...
$(function () {
     ...
     $(document).on('click', ".open_form", function () {
         ...
         window.open("/adm/main_visual_form.do?dm_id="+dm_id, "mainvisual_detail",option);
     });
...
<div class="easyui-layout" style="width:700px;height:350px;" fit="true">
                ...
                <dl>
                    ...
                    <dd>
                        <select name="search_type" id="search_type">
                            ...
                            <option value="dm_visual_alt">제목</option>
                        </select>
    ...
    <div data-options="region:'center', border:false" class="Contents">
        <table id="dg"
               ...
               data-options="pagePosition:'top',rownumbers:true,pagination:true, singleSelect:true,url:'/adm/get_main_visual_list.do',method:'post',fitColumns:true,striped:false,selectOnCheck:false,checkOnSelect:false,footer:'#ft'"
            ...
            editor:{
                ...
                <th data-options="field:'dm_visual_alt',width:200,align:'center'">제목</th>
