...
function fnSetData() {
    ...
    $.ajax({
        url: "/adm/get_statistics_member.do?mode=all_day_member&search_start_date=" + search_start_date + "&search_end_date=" + search_end_date,
        dataType: "json",
    ...
    $.ajax({
        url: "/adm/get_statistics_member.do?mode=all_day_member_chart&search_start_date=" + search_start_date + "&search_end_date=" + search_end_date,
        dataType: 'json',
        type: 'post',
        success: function (data) {
            $("#chart-area").empty();
...
function fnSetTable(){
    ...
    var search_end_date = $("#search_end_date").datebox('getValue');
    $('#dg').datagrid({
        url:'/adm/get_statistics_member.do?mode=all_day_member_table',
        columns:[[
            {field:'dm_datetime',title:'날짜',width:80,align:'center'},
            {field:'total',title:'총 회원수',width:80,align:'center'},
            {field:'leave',title:'탈퇴회원수',width:80,align:'center'}
        ]],
        queryParams:{
...
<div class="easyui-layout" fit="true">
    ...
    <div data-options="region:'center', border:false" class="Contents">
    	<ul class="Tabs mt30">
		    ...
		    <li class="on"><a  onclick="location.href='/adm/all_member.do'">일별 전체회원 현황</a></li>
