...
function fnSetData() {
    ...
    $.ajax({
        url: "/adm/get_statistics_member.do?mode=day_member&search_start_date=" + search_start_date + "&search_end_date=" + search_end_date,
        dataType: "json",
        success: function (data) {
            ...
            $("#max_date").text(max_date[0]);
            $("#min_count").text(data.min_count);
            $("#min_date").text(min_date[0]);
    ...
    $.ajax({
        url: "/adm/get_statistics_member.do?mode=day_member_chart&search_start_date=" + search_start_date + "&search_end_date=" + search_end_date,
        dataType: "json",
        success: function (data) {
            $("#chart-area").empty();
...
function fnSetTable(){
    ...
    var search_end_date = $("#search_end_date").datebox('getValue');
    $('#dg').datagrid({
        url:'/adm/get_statistics_member.do?mode=day_member_table',
        columns:[[
...
<div class="easyui-layout" fit="true">
    ...
    <div data-options="region:'center', border:false" class="Contents">
    	<ul class="Tabs mt30">
		    <li class="on"><a  onclick="location.href='/adm/new_member.do'">일별 신규회원 현황</a></li>
            ...
            <table class="tb">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <em id="min_date">2020-10-20</em>
                    </td>
                    <td>
                        <strong id="max_count">0</strong>
                        <em id="max_date">2020-10-20</em>
                    </td>
                </tr>
                </tbody>
            </table>
