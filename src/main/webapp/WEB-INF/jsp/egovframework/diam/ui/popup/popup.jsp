...
function fnNew() {
	window.open("/adm/popup_form.do","popup_new",option);    
}
...
$(function () {
    ...
    $(document).on('click', ".open_form", function () {
        ...
        window.open("/adm/popup_form.do?dm_id="+dm_id, "popup_detail",option);
    });
...
<div class="easyui-layout" style="width:700px;height:350px;" fit="true">
    ...
    <div data-options="region:'center', border:false" class="Contents">
        <table id="dg"
               ...
               data-options="pagePosition:'top',rownumbers:true,pagination:true, singleSelect:true,url:'/adm/get_popup_list.do',method:'post',fitColumns:true,striped:false,selectOnCheck:false,checkOnSelect:false,footer:'#ft'"
